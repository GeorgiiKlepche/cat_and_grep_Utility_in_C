...
"-e regex -e ^print s21_grep.c VAR -f test/test_ptrn_grep.txt"
"-e while -e void s21_grep.c Makefile VAR -f test/test_ptrn_grep.txt"
"VAR no_file.txt"
)
...
"-c -l aboba test/test_1.txt test/test_5_grep.txt"
...
"-l for no_file.txt test/test_2_grep.txt"
